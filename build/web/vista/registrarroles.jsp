            ...
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <%
                        ...
                        tipoList = tipo_dao.ConsultarListarTipo_usuario(' ', buscando);
                        out.println("<table class='table table-primary table-striped table-hover table-bordered border-danger'><tr><td>Identificación</td><td>Descripcion tipo usuario</td>");
