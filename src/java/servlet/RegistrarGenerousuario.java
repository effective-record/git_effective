 ...
 * @author AndresSaenz
 */
@WebServlet(name = "RegistrarGenerousuario", urlPatterns = {"/RegistrarGenerousuario"})
public class RegistrarGenerousuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String BanderaGenero = request.getParameter("BanderaReg");
        ...
        System.out.println("El valor es " + BanderaGenero);

        if (BanderaGenero.equals("Correcto")) {
            String respuestaRegistrada = mi_genero_usuario_dao.AdicionarGenero_usuario(mi_genero_usuario);
            ...
            System.out.println("El valor no es correcto " + BanderaGenero);
