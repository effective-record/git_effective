...
public class ActualizarProveedores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String identificacion_proveedor = request.getParameter("identificacion_proveedor");
        ...
        String telefono_1_proveedor = request.getParameter("telefono_1_proveedor");
        String telefono_2_proveedor = request.getParameter("telefono_2_proveedor");
        ...
        mi_proveedor.setIdentificacion_proveedor(identificacion_proveedor);
        mi_proveedor.setNombre_proveedor(nombre_proveedor);
        mi_proveedor.setCorreo_proveedor(correo_proveedor);
        mi_proveedor.setDireccion_proveedor(direccion_proveedor);
        mi_proveedor.setTelefono_1_proveedor(telefono_1_proveedor);
        mi_proveedor.setTelefono_2_proveedor(telefono_2_proveedor);
        
        
         System.out.println("identificacion_proveedor: " + identificacion_proveedor);
        String respuestaRegistrada = mi_proveedor_dao.ModificarProveedores(mi_proveedor);
