 ...
 * @author AndresSaenz
 */
@WebServlet(name = "RegistrarTipodocumento", urlPatterns = {"/RegistrarTipodocumento"})
public class RegistrarTipodocumento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TIPO_DOC_IDENTIFICACION_USUARIO mi_tipo_doc = new TIPO_DOC_IDENTIFICACION_USUARIO();
        TIPO_DOC_IDENTIFICACION_USUARIO_DAO mi_tipo_doc_dao = new TIPO_DOC_IDENTIFICACION_USUARIO_DAO();

        mi_tipo_doc.setTipo_doc_identificacion_usuario(tipo_doc);

        System.out.println("El valor es " + Bandera);

        if (Bandera.equals("Correcto")) {
            String respuestaRegistrada = mi_tipo_doc_dao.AdicionarTipo_doc_usuario(mi_tipo_doc);
